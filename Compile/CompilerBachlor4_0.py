...
for linje in komandoer:
    ...
    if linje[0] == "jump" or linje[0] == "bop" or linje[0] == "bon" or linje[0] == "boz" or linje[0] == "bnz" or linje[0] == "boo" or linje[0] == "bno" or linje[0] == "bou" or linje[0] == "bnu" or linje[0] == "boc" or linje[0] == "bnc":
        kode.append(linje)
        programlengde += 3
    elif linje[0] == "nop" or linje[0] == "Clear" or linje[0] == "clear"or linje[0] == "inc" or linje[0] == "dec" or linje[0] == "rs" or linje[0] == "not" or linje[0] == "and" or linje[0] == "or" or linje[0] == "add" or linje[0] == "addc" or linje[0] == "mov" or linje[0] == "xor":
        kode.append(linje)
        programlengde += 1
    elif linje[0] == "def":
        kode.append(linje)
...
for linje in kode:
    ...
    if linje[0] == "nop":
        ...
        if linje[1] == "a":
            temp.append("0x14 #load a") #wrong opcode in docs
        elif linje[1] == "b":
            temp.append("0x15 #load b")
        elif linje[1] == "c":
            temp.append("0x16 #load c")
        elif linje[1] == "d":
            temp.append("0x17 #load d")
        else:
            errorList.append(linje)
            temp.append("0x00 #error")
        ...
        if linje[1] == "a":
            temp.append("0x18 #store a")
        elif linje[1] == "b":
            temp.append("0x19 #store b")
        elif linje[1] == "c":
            temp.append("0x1a #store c")
        elif linje[1] == "d":
            temp.append("0x1b #store d")
        else:
            errorList.append(linje)
            temp.append("0x00 #error")
        ...
        if linje[1] == "a":
            temp.append("0x1c #inc a")
        elif linje[1] == "b":
            temp.append("0x1d #inc b")
        elif linje[1] == "c":
            temp.append("0x1e #inc c")
        elif linje[1] == "d":
            temp.append("0x1f #inc d")
        else:
            errorList.append(linje)
            temp.append("0x00 #error")
        ...
        if linje[1] == "a":
            temp.append("0x20 #dec a")
        elif linje[1] == "b":
            temp.append("0x21 #dec b")
        elif linje[1] == "c":
            temp.append("0x22 #dec c")
        elif linje[1] == "d":
            temp.append("0x23 #dec d")
        else:
            errorList.append(linje)
            temp.append("0x00 #error")
        ...
        if linje[1] == "a":
            temp.append("0x24 #rs a")
        elif linje[1] == "b":
            temp.append("0x25 #rs b")
        elif linje[1] == "c":
            temp.append("0x26 #rs c")
        elif linje[1] == "d":
            temp.append("0x27 #rs d")
        else:
            errorList.append(linje)
            temp.append("0x00 #error")
        ...
        if linje[1] == "a":
            if linje[2] == "a":
                temp.append("0x50 #xor a a")
            elif linje[2] == "b":
                temp.append("0x51 #xor a b")
            elif linje[2] == "c":
                temp.append("0x52 #xor a c")
            elif linje[2] == "d":
                temp.append("0x53 #xor a d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x54 #xor b a")
            elif linje[2] == "b":
                temp.append("0x55 #xor b b")
            elif linje[2] == "c":
                temp.append("0x56 #xor b c")
            elif linje[2] == "d":
                temp.append("0x57 #xor b d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x58 #xor c a")
            elif linje[2] == "b":
                temp.append("0x59 #xor c b")
            elif linje[2] == "c":
                temp.append("0x5a #xor c c")
            elif linje[2] == "d":
                temp.append("0x5b #xor c d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x5c #xor d a")
            elif linje[2] == "b":
                temp.append("0x5d #xor d b")
            elif linje[2] == "c":
                temp.append("0x5e #xor d c")
            elif linje[2] == "d":
                temp.append("0x5f #xor d d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
        else:
        ...
        if linje[1] == "a":
            if linje[2] == "a":
                temp.append("0x60 #add a a")
            elif linje[2] == "b":
                temp.append("0x61 #add a b")
            elif linje[2] == "c":
                temp.append("0x62 #add a c")
            elif linje[2] == "d":
                temp.append("0x63 #add a d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x64 #add b a")
            elif linje[2] == "b":
                temp.append("0x65 #add b b")
            elif linje[2] == "c":
                temp.append("0x66 #add b c")
            elif linje[2] == "d":
                temp.append("0x67 #add b d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x68 #add c a")
            elif linje[2] == "b":
                temp.append("0x69 #add c b")
            elif linje[2] == "c":
                temp.append("0x6a #add c c")
            elif linje[2] == "d":
                temp.append("0x6b #add c d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x6c #add d a")
            elif linje[2] == "b":
                temp.append("0x6d #add d b")
            elif linje[2] == "c":
                temp.append("0x6e #add d c")
            elif linje[2] == "d":
                temp.append("0x6f #add d d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
        else:
        ...
        if linje[1] == "a":
            if linje[2] == "a":
                temp.append("0x70 #addc a a")
            elif linje[2] == "b":
                temp.append("0x71 #addc a b")
            elif linje[2] == "c":
                temp.append("0x72 #addc a c")
            elif linje[2] == "d":
                temp.append("0x73 #addc a d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x74 #addc b a")
            elif linje[2] == "b":
                temp.append("0x75 #addc b b")
            elif linje[2] == "c":
                temp.append("0x76 #addc b c")
            elif linje[2] == "d":
                temp.append("0x77 #addc b d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x78 #addc c a")
            elif linje[2] == "b":
                temp.append("0x79 #addc c b")
            elif linje[2] == "c":
                temp.append("0x7a #addc c c")
            elif linje[2] == "d":
                temp.append("0x7b #addc c d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x7c #addc d a")
            elif linje[2] == "b":
                temp.append("0x7d #addc d b")
            elif linje[2] == "c":
                temp.append("0x7e #addc d c")
            elif linje[2] == "d":
                temp.append("0x7f #addc d d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
        else:
        ...
        if linje[1] == "a":
            if linje[2] == "a":
                temp.append("0x80 #mov a a")
            elif linje[2] == "b":
                temp.append("0x81 #mov a b")
            elif linje[2] == "c":
                temp.append("0x82 #mov a c")
            elif linje[2] == "d":
                temp.append("0x83 #mov a d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x84 #mov b a")
            elif linje[2] == "b":
                temp.append("0x85 #mov b b")
            elif linje[2] == "c":
                temp.append("0x86 #mov b c")
            elif linje[2] == "d":
                temp.append("0x87 #mov b d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x88 #mov c a")
            elif linje[2] == "b":
                temp.append("0x89 #mov c b")
            elif linje[2] == "c":
                temp.append("0x8a #mov c c")
            elif linje[2] == "d":
                temp.append("0x8b #mov c d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
            ...
            if linje[2] == "a":
                temp.append("0x8c #mov d a")
            elif linje[2] == "b":
                temp.append("0x8d #mov d b")
            elif linje[2] == "c":
                temp.append("0x8e #mov d c")
            elif linje[2] == "d":
                temp.append("0x8f #mov d d")
            else:
                errorList.append(linje)
                temp.append("0x00 #error")
        else:
...
def hexdump_compact(filename, bytes_per_line=256):
