...
architecture RTL of clock_controller_ver_2 is
  ...
  signal counter_goal : integer := 0;
  signal n_int_calc   : integer;
  ...
  begin
    if rising_edge(clk) then
      ...
      if rst_n = '0' then
        ...
        n_int_calc <= to_integer(unsigned(n));
        exponent <= (n_int_calc/10) - 1;
        case n_int_calc is -- (*@\label{start:clock_controller_switch}@*)
          when 9 downto 0 =>
            n_int <= n_int_calc + 1;
